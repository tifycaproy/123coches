...
<head>
    ...
    <link rel="css/flexslider.css" type="{{asset('text/css')}}" media="screen">
    ...
    <style type="text/css">.gm-style {
        ...
        .gm-style img { max-width: none; }</style><script type="text/javascript" charset="UTF-8" src="{{asset('js/onion.js')}}"></script>
